...
const headCells: HeadCell[] = [
  ...
  { id: "TotalPassed", numeric: true, disablePadding: false, label: "Passed" },
];
...
export default function CountriesTable(props: ICountriesTable) {
      ...
      <Paper className={classes.paper} elevation={0}>
        ...
        <TableContainer>
          <Table
            ...
            aria-label="covid statistics table for all countries"
          >
            <EnhancedTableHead
              classes={classes}
            ...
            />
            <TableBody>
              {stableSort(data.Countries, getComparator(order, orderBy))
